            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-white/5 p-8 rounded-2xl text-center border border-white/10">
                <p className="text-5xl font-bold text-yellow-400">
                  60${" "}
                  <span className="text-3xl text-white/50">+ taxes / h</span>
                </p>
              ...
              <div className="bg-white/5 p-8 rounded-2xl text-center border border-white/10">
                ...
                <p className="text-lg mt-2 text-gray-300">sans activité</p>
              </div>
            </div>
            <motion.button
              className="w-full max-w-md mx-auto mt-10 block py-5 text-xl font-bold uppercase rounded-lg bg-yellow-400 text-black shadow-lg shadow-yellow-400/30"
        ...
        <div className="p-4 bg-black/30 flex justify-center border-b border-white/10">
          {tabs.map((tab) => (
            <button
              ...
              } relative rounded-full px-4 py-2.5 text-lg font-medium text-white transition-colors`}
            >
              {activeTab === tab.id && (
                <motion.span
